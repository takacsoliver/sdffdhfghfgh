   ...
   <div id="content">
        <div id="leftContent">
            <div id="theTimer">
				<div class="wheel">
					...
					<div class="hashcontainer">
							...
							<a href="https://steamcommunity.com/tradeoffer/new/?partner=417582087&token=G_fhsZl4" target="_blank" class="bigBTN">DEPOSIT<span>min $5, max 15 items, no souvenir items</span></a><?php else: ?><a href="?login"  class="bigBTN">LOGIN<span>Please Login to Deposit</span></a>	<?php endif; ?>
			            <div id="jackpotInfo">
			...
			<div id="userPartnerInfo">
				Add <font color=#ff0000><b>betandwinskins.com</b></font> to your steam name and get <font color=#00cb26><b>5% Chance</b></font> to your win (re-log)			</div>
        </div>
        <div id="rightContent">
...
<div id="loading"></div>
 </body>	<script src="/static/js/appb_new.js"></script>
