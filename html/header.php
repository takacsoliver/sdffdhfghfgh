...
<meta name="description" content="Csgo gambling site" />
	...
	<meta name="msapplication-TileImage" content="http://betandwinskins.com/static/favicon/mstile-144x144.png">
...
::-webkit-scrollbar-thumb:window-inactive {
 ...
 <div class="loader"></div>
   ...
   <div id="header">
        <div id="mainHeader">
            <a href="index.php" id="logo"><img src="../images/logo.png" alt="logo" style="width: 308px;height: 79px;margin-top: 7px;"></a>
            <div id="nav" style="z-index:1000000000; position:relative;margin-left:-50px;" >
                <a href="http://betandwinskins.com/">Jackpot</a>
		...
		<?php if(isset($_SESSION['steamid'])): ?>
					...
					<div class="UserPanelInfo">
						<a href="http://betandwinskins.com/settings.php" class="username"><?=$_SESSION['name'] ?></a>
