...
if(isset($_SESSION['steamid'])) {
	...
	<!-- meta --><meta name="description" content="BETANDWINSKINS | CSGO JACKPOT SITE" />
	<meta charset="utf-8"/>
...
<script src="dist/sweetalert.min.js"></script> <link rel="stylesheet" type="text/css" href="dist/sweetalert.css">
	<!-- tipTip -->
	<script type="text/javascript" src="/static/js/tipTip/jquery.tipTip.js"></script>

	<!-- isotope -->
	<script type="text/javascript" src="/static/js/isotope/isotope.pkgd.min.js"></script>
	<script type="text/javascript" src="/static/js/isotope/horizontal.js"></script>

	<!-- knob -->
	<!--[if IE]><script type="text/javascript" src="/static/js/knob/excanvas.js"></script><![endif]-->
	<script type="text/javascript" src="/static/js/knob/jquery.knob.min.js"></script>

	<!-- scrollbar -->
	<script type="text/javascript" src="/static/js/scrollbar/jquery.scrollbar.min.js"></script>
	
	<!-- particles.js 
	<script type="text/javascript" src="/static/js/particles/particles.min.js"></script>
	<script type="text/javascript" src="/static/js/particles/loadparticles.js"></script>
	-->
	<!-- pace -->
	<script type="text/javascript" src="/static/js/pace/pace.min.js"></script>
	<script src='http://cdn.rawgit.com/admsev/jquery-play-sound/master/jquery.playSound.js'></script>
	<!-- roulette -->
	<!--<script type="text/javascript" src="http://betandwinskins.com/static/js/roulette/roulette.min.js"></script>-->
...
<div id="myModal" class="modal">
 ...
 <div ng-show="!user.authenticated" id="overlay" class="" style="">
    <div id="overlay-footer">
      <a target="_blank" href="http://twitter.com/betandwinskins">
        <i class="fa fa-twitter"></i>
      </a>
      </a>
      <a target="_blank" href="https://steamcommunity.com/groups/betandwinskins">
    ...
    <div id="the-overlay-content">
      <div id="overlay-logo">
        ...
        <p id="bottom-line">BET AND WIN SKINS JACKPOT SITE</p>
      </div>
      <div>
		<a href="/?login"><img src="images/slogin.png" style="width:334px;height:50px;">
      </div>
   ...
   <div id="header">
        <div id="mainHeader">
            <a href="http://betandwinskins.com/" id="logo"><img src="../images/logo.png" alt="logo" style="width: 250px;height: 79px;margin-top: 7px;"></a>
            <div id="nav" style="z-index:190000; position:relative;margin-left:-50px;" >
                <a href="http://betandwinskins.com/">Play</a>
                <a href="http://betandwinskins.com/history.php">history</a>
                <a href="http://betandwinskins.com/ranking.php">leaderboard</a>
				<a href="http://betandwinskins.com/partners.php">partners</a>
				<a href="http://betandwinskins.com/giveaway.php">giveaway</a>
				<!--
