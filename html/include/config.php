...
$accesspassword='T!m1efz[xm-h53Un'; //set this up in bot as well, for accessing /cost.php, /endgame.php
...
$adminslist=array(
		'76561198331338945', // people that can access /admin.php while logged in
		''
	);
